# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2016-11-30 06:25
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(blank=True, choices=[(b'supporter', b'SUPPORTER'), (b'consultant', b'CONSULTANT')], max_length=15, null=True)),
                ...
                ('status', models.CharField(blank=True, choices=[(b'active', b'ACTIVE'), (b'less_active', b'LESS_ACTIVE'), (b'independent', b'INDEPENDENT')], max_length=15, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reply', to='consultant_app.Comment')),
